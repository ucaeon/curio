...
from app.ingestion.tour.fetch import fetch_and_save_raw
from app.preprocessing.tour.transform import transform_and_save
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="한국관광공사 관광 데이터 수집 및 전처리")
...
def main() -> None:
    ...
    processed_path = transform_and_save(
        raw_path=raw_path,
        output_dir=Path(settings.processed_tour_dir),
    )
