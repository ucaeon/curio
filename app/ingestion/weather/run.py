...
from app.ingestion.weather.fetch import fetch_and_save_raw
from app.preprocessing.weather.transform import transform_and_save
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="기상청 단기예보 수집 및 전처리")
...
def main() -> None:
    ...
    processed_path = transform_and_save(
        raw_path=raw_path,
        output_dir=Path(settings.processed_weather_dir),
    )
